...
(function () {
     ...
     const showFavourites = document.getElementById("favoriteSection");
     ...
     async function fetchMovies(search) {
          const url = `https://www.omdbapi.com/?t=${search}&apikey=aa0a4941`;
          try {
     ...
     async function handleClickListner(e) {
          ...
          if (target.classList.contains("add-fav")) {
               ...
               if (showFavourites.style.display == "flex") {
                    document.getElementById("favourites").style.color = "#8b9595";
                    showFavourites.style.display = "none";
               } else {
                    showFavourites.classList.add("animate__backInRight");
                    document.getElementById("favourites").style.color =
                         "var(--logo-color)";
